...
class SearchBar extends Component {
  render() {
      ...
      a vanilla HTML concept. */
    return <input onChange={this.handleInputChange} />;
  }
  /* The event handler is a function that should
    be ran whenever an event occurs.  An 'event' object must
    be passed in as an argument, although you can name it
    whatever you want. The event object provides information about
    the event that occured. For our SearchBar component, we'll
    use the event object to get access to the value of the input,
